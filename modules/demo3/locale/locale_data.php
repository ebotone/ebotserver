...
function getDemo3Mas()
{
	...
	$local_mas[] = $add;	
		...
		$add['rus'] = 'Вас приветствует Ebot Server. Это сообщение сгенерировано демо скриптом get_demo3.php а этот текст можно отредактировать в массиве файла locale_data.php по пути к текущему демо модулю /modules/demo3/locale/locale_data.php';
		$add['eng'] = "Welcome to Reboot Server. This message was generated by the demo script get_demo3.php and this text can be edited in the file array locale_data.php on the path to the current demo module /modules/demo3/locale/locale_data.php";
		$add['deu'] = '';
