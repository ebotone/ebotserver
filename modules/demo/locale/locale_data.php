...
function getDemoMas()
{
	...
	$local_mas[] = $add;	
		...
		$add['rus'] = 'Вас приветствует Ebot Server. Это сообщение сгенерировано демо скриптом get_demo.php а этот текст можно отредактировать в массиве файла locale_data.php по пути к текущему демо модулю /modules/demo/locale/locale_data.php';
