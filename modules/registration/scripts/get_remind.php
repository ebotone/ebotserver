...
require_once(realpath(__DIR__) . '/../../../settings.php');//Настройки
	...
	$locale_includes[] = 'registration';//Сюда прописываем название текущего модуля (название папки в modules)
...
// https://xn--80aalw.xn--80addj8aakhjc.xn--p1ai/all/kada/modules/registration/scripts/get_hash.php
