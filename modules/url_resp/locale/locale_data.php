...
function getUrl_respMas()
{
	...
	$local_mas[] = $add;	
		...
		$add['rus'] = 'Вас приветствует Ebot Server. Это сообщение сгенерировано демо сктиптом get_demo.php а этот текст можно отредактировать в массиве файла locale_data.php по пути к текущему демо модулю /modules/demo/locale/locale_data.php';
		$add['eng'] = "Welcome to Reboot Server. This message was generated by the demo script get_demo.php and this text can be edited in the file array locale_data.php on the path to the current demo module /modules/demo/locale/locale_data.php";
		$add['deu'] = '';
	...
	$local_mas[] = $add;	
		...
		$add['abv'] = 'you_are_welcomed_by_the_system';
		$add['rus'] = 'Вас приветствует система';
		$add['eng'] = "You are welcomed by the system";
		$add['deu'] = '';
	...
	$local_mas[] = $add;
		...
		$add['abv'] = 'the_text_generated_by_the_script';
		$add['rus'] = 'Текст сгенерирован скриптом';
		$add['eng'] = "The text generated by the script";
		$add['deu'] = '';
	...
	$local_mas[] = $add;	
		...
		$add['abv'] = 'sys_sender_version';
		$add['rus'] = 'Версия библиотеки sys_sender';
		$add['eng'] = "The version of the library sys_sender";
		$add['deu'] = '';
